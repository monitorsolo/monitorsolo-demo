...
st.title("Comparador: Historia Clínica vs CRF")

st.markdown("Sube un archivo de texto clínico (.txt) y otro CSV de CRF para comparar los datos automáticamente.")

# Subida del texto clínico simulado
archivo_txt = st.file_uploader("📄 Subir texto clínico (.txt)", type="txt")

# Subida del archivo CRF
archivo_crf = st.file_uploader("📄 Subir archivo CRF (.csv)", type="csv")
